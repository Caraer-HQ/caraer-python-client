...
class TestAnalyticsSeriesConfig(unittest.TestCase):
    """AnalyticsSeriesConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalyticsSeriesConfig:
        """Test AnalyticsSeriesConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyticsSeriesConfig`
        """
        model = AnalyticsSeriesConfig()
        if include_optional:
            return AnalyticsSeriesConfig(
    ...
    def testAnalyticsSeriesConfig(self):
        """Test AnalyticsSeriesConfig"""
