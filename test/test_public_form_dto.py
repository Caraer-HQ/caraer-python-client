...
class TestPublicFormDTO(unittest.TestCase):
    """PublicFormDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicFormDTO:
        """Test PublicFormDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicFormDTO`
        """
        model = PublicFormDTO()
        if include_optional:
