...
class TestCmsPageDTO(unittest.TestCase):
    """CmsPageDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CmsPageDTO:
        """Test CmsPageDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CmsPageDTO`
        """
        model = CmsPageDTO()
        if include_optional:
            return CmsPageDTO(
