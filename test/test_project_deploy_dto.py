...
class TestProjectDeployDTO(unittest.TestCase):
    """ProjectDeployDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectDeployDTO:
        """Test ProjectDeployDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDeployDTO`
        """
        model = ProjectDeployDTO()
        if include_optional:
            return ProjectDeployDTO(
                uuid = '0',
                name = '0',
                label = '',
                created_at = 56,
