...
class TestPropertyFormat(unittest.TestCase):
    """PropertyFormat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyFormat:
        """Test PropertyFormat
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyFormat`
        """
        model = PropertyFormat()
        if include_optional:
