...
class TestShowResponse(unittest.TestCase):
    """ShowResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowResponse:
        """Test ShowResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowResponse`
        """
        model = ShowResponse()
        if include_optional:
            return ShowResponse(
