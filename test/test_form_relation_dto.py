...
class TestFormRelationDTO(unittest.TestCase):
    """FormRelationDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FormRelationDTO:
        """Test FormRelationDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FormRelationDTO`
        """
        model = FormRelationDTO()
        if include_optional:
            return FormRelationDTO(
                ...
                relation = caraer_client.models.relation_dto.RelationDTO(
                    ...
                    immutable = True, 
                    editable = True, ),
                related_relation = caraer_client.models.relation_dto.RelationDTO(
                    uuid = '0', 
                    name = '', 
                    label = '', 
                    created_at = 56, 
                    ...
                    immutable = True, 
                    editable = True, ),
                related_object = caraer_client.models.caraer_object_dto.CaraerObjectDTO(
                    uuid = '0', 
                    name = '', 
                    label = '', 
                    created_at = 56, 
