...
class TestBulkDeleteRecordsRequest(unittest.TestCase):
    """BulkDeleteRecordsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkDeleteRecordsRequest:
        """Test BulkDeleteRecordsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkDeleteRecordsRequest`
        """
        model = BulkDeleteRecordsRequest()
        if include_optional:
    ...
    def testBulkDeleteRecordsRequest(self):
        """Test BulkDeleteRecordsRequest"""
