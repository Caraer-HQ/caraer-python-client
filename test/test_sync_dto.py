...
class TestSyncDTO(unittest.TestCase):
    """SyncDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyncDTO:
        """Test SyncDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyncDTO`
        """
        model = SyncDTO()
        if include_optional:
            return SyncDTO(
                ...
                index = 56,
                mappings = [
                    caraer_client.models.mapping_dto.MappingDTO(
                        uuid = '0', 
                        name = '0', 
                        label = '', 
                        created_at = 56, 
                        ...
                        active = True, 
                        mapping_items = [
                            caraer_client.models.mapping_item_dto.MappingItemDTO(
                                uuid = '0', 
                                name = '0', 
                                label = '', 
                                created_at = 56, 
                                ...
                                index = 56, 
                                source_field = '', 
                                target_object = caraer_client.models.caraer_object_dto.CaraerObjectDTO(
                                    uuid = '0', 
                                    name = '', 
                                    label = '', 
                                    created_at = 56, 
