...
class TestAppInboundRouteDTO(unittest.TestCase):
    """AppInboundRouteDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppInboundRouteDTO:
        """Test AppInboundRouteDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppInboundRouteDTO`
        """
        model = AppInboundRouteDTO()
        if include_optional:
            return AppInboundRouteDTO(
                uuid = '0',
                name = '0',
                label = '',
                created_at = 56,
    ...
    def testAppInboundRouteDTO(self):
        """Test AppInboundRouteDTO"""
