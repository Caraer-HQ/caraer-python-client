...
class TestDeveloperSandboxDTO(unittest.TestCase):
    """DeveloperSandboxDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeveloperSandboxDTO:
        """Test DeveloperSandboxDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeveloperSandboxDTO`
        """
        model = DeveloperSandboxDTO()
        if include_optional:
            return DeveloperSandboxDTO(
                uuid = '0',
                name = '0',
                label = '',
                created_at = 56,
    ...
    def testDeveloperSandboxDTO(self):
        """Test DeveloperSandboxDTO"""
