...
class TestAppBarDTO(unittest.TestCase):
    """AppBarDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppBarDTO:
        """Test AppBarDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppBarDTO`
        """
        model = AppBarDTO()
        if include_optional:
            return AppBarDTO(
