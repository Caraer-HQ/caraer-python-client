...
class TestWebpageAccessGrantDTO(unittest.TestCase):
    """WebpageAccessGrantDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebpageAccessGrantDTO:
        """Test WebpageAccessGrantDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebpageAccessGrantDTO`
        """
        model = WebpageAccessGrantDTO()
        if include_optional:
            return WebpageAccessGrantDTO(
                uuid = '0',
                name = '0',
                label = '',
                created_at = 56,
    ...
    def testWebpageAccessGrantDTO(self):
        """Test WebpageAccessGrantDTO"""
