...
class TestServerlessFunctionDTO(unittest.TestCase):
    """ServerlessFunctionDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServerlessFunctionDTO:
        """Test ServerlessFunctionDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServerlessFunctionDTO`
        """
        model = ServerlessFunctionDTO()
        if include_optional:
            return ServerlessFunctionDTO(
                uuid = '0',
                name = '0',
                label = '',
                created_at = 56,
    ...
    def testServerlessFunctionDTO(self):
        """Test ServerlessFunctionDTO"""
