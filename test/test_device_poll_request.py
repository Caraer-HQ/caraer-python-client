...
class TestDevicePollRequest(unittest.TestCase):
    """DevicePollRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DevicePollRequest:
        """Test DevicePollRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DevicePollRequest`
        """
        model = DevicePollRequest()
        if include_optional:
    ...
    def testDevicePollRequest(self):
        """Test DevicePollRequest"""
