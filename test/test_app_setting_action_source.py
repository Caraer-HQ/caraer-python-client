...
class TestAppSettingActionSource(unittest.TestCase):
    """AppSettingActionSource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppSettingActionSource:
        """Test AppSettingActionSource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppSettingActionSource`
        """
        model = AppSettingActionSource()
        if include_optional:
            return AppSettingActionSource(
                type = '',
    ...
    def testAppSettingActionSource(self):
        """Test AppSettingActionSource"""
