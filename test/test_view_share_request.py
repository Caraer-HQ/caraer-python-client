...
class TestViewShareRequest(unittest.TestCase):
    """ViewShareRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewShareRequest:
        """Test ViewShareRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewShareRequest`
        """
        model = ViewShareRequest()
        if include_optional:
            return ViewShareRequest(
                users = [
