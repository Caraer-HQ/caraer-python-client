...
class TestAnalyticsDashboardConfig(unittest.TestCase):
    """AnalyticsDashboardConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalyticsDashboardConfig:
        """Test AnalyticsDashboardConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyticsDashboardConfig`
        """
    ...
    def testAnalyticsDashboardConfig(self):
        """Test AnalyticsDashboardConfig"""
