...
class TestFormWithAiPromptDTO(unittest.TestCase):
    """FormWithAiPromptDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FormWithAiPromptDTO:
        """Test FormWithAiPromptDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FormWithAiPromptDTO`
        """
        model = FormWithAiPromptDTO()
        if include_optional:
            return FormWithAiPromptDTO(
                uuid = '0',
                name = '0',
                label = '',
                created_at = 56,
    ...
    def testFormWithAiPromptDTO(self):
        """Test FormWithAiPromptDTO"""
