...
class TestBillingSettingsDTO(unittest.TestCase):
    """BillingSettingsDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillingSettingsDTO:
        """Test BillingSettingsDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillingSettingsDTO`
        """
        model = BillingSettingsDTO()
        if include_optional:
            return BillingSettingsDTO(
                uuid = '0',
                name = '0',
                label = '',
                created_at = 56,
    ...
    def testBillingSettingsDTO(self):
        """Test BillingSettingsDTO"""
