...
class TestGraphPathEvidence(unittest.TestCase):
    """GraphPathEvidence unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GraphPathEvidence:
        """Test GraphPathEvidence
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GraphPathEvidence`
        """
        model = GraphPathEvidence()
        if include_optional:
    ...
    def testGraphPathEvidence(self):
        """Test GraphPathEvidence"""
