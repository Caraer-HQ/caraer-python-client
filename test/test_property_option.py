...
class TestPropertyOption(unittest.TestCase):
    """PropertyOption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyOption:
        """Test PropertyOption
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyOption`
        """
