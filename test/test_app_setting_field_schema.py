...
class TestAppSettingFieldSchema(unittest.TestCase):
    """AppSettingFieldSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppSettingFieldSchema:
        """Test AppSettingFieldSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppSettingFieldSchema`
        """
        model = AppSettingFieldSchema()
        if include_optional:
    ...
    def testAppSettingFieldSchema(self):
        """Test AppSettingFieldSchema"""
