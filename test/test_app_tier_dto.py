...
class TestAppTierDTO(unittest.TestCase):
    """AppTierDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppTierDTO:
        """Test AppTierDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppTierDTO`
        """
        model = AppTierDTO()
        if include_optional:
            return AppTierDTO(
