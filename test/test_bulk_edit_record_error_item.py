...
class TestBulkEditRecordErrorItem(unittest.TestCase):
    """BulkEditRecordErrorItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkEditRecordErrorItem:
        """Test BulkEditRecordErrorItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkEditRecordErrorItem`
        """
        model = BulkEditRecordErrorItem()
        if include_optional:
            return BulkEditRecordErrorItem(
                uuid = '',
                client_ref = '',
                message = '',
                errors = [
    ...
    def testBulkEditRecordErrorItem(self):
        """Test BulkEditRecordErrorItem"""
