...
class TestUsedInResult(unittest.TestCase):
    """UsedInResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsedInResult:
        """Test UsedInResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsedInResult`
        """
        model = UsedInResult()
        if include_optional:
            return UsedInResult(
