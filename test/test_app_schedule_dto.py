...
class TestAppScheduleDTO(unittest.TestCase):
    """AppScheduleDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppScheduleDTO:
        """Test AppScheduleDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppScheduleDTO`
        """
        model = AppScheduleDTO()
        if include_optional:
            return AppScheduleDTO(
                uuid = '0',
                name = '0',
                label = '',
                created_at = 56,
