...
class TestCompanyDetailsDTO(unittest.TestCase):
    """CompanyDetailsDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyDetailsDTO:
        """Test CompanyDetailsDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyDetailsDTO`
        """
        model = CompanyDetailsDTO()
        if include_optional:
    ...
    def testCompanyDetailsDTO(self):
        """Test CompanyDetailsDTO"""
