...
class TestFilledProperty(unittest.TestCase):
    """FilledProperty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilledProperty:
        """Test FilledProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilledProperty`
        """
