...
class TestAppDetailsDTO(unittest.TestCase):
    """AppDetailsDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppDetailsDTO:
        """Test AppDetailsDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppDetailsDTO`
        """
        model = AppDetailsDTO()
        if include_optional:
