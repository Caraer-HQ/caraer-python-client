...
class TestCaraerObjectDTO(unittest.TestCase):
    """CaraerObjectDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CaraerObjectDTO:
        """Test CaraerObjectDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CaraerObjectDTO`
        """
        model = CaraerObjectDTO()
        if include_optional:
            return CaraerObjectDTO(
                uuid = '0',
                name = '',
                label = '',
                created_at = 56,
