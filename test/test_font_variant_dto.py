...
class TestFontVariantDTO(unittest.TestCase):
    """FontVariantDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FontVariantDTO:
        """Test FontVariantDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FontVariantDTO`
        """
        model = FontVariantDTO()
        if include_optional:
            return FontVariantDTO(
                weight = 56,
                style = '',
                url = ''
            )
