...
class TestAppExternalOAuthProviderDTO(unittest.TestCase):
    """AppExternalOAuthProviderDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppExternalOAuthProviderDTO:
        """Test AppExternalOAuthProviderDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppExternalOAuthProviderDTO`
        """
        model = AppExternalOAuthProviderDTO()
        if include_optional:
            return AppExternalOAuthProviderDTO(
                uuid = '0',
                name = '0',
                label = '',
                created_at = 56,
    ...
    def testAppExternalOAuthProviderDTO(self):
        """Test AppExternalOAuthProviderDTO"""
