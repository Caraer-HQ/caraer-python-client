...
class TestCurrencyRange(unittest.TestCase):
    """CurrencyRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrencyRange:
        """Test CurrencyRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyRange`
        """
        model = CurrencyRange()
        if include_optional:
