...
class TestEventRsvpRequest(unittest.TestCase):
    """EventRsvpRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventRsvpRequest:
        """Test EventRsvpRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventRsvpRequest`
        """
        model = EventRsvpRequest()
        if include_optional:
