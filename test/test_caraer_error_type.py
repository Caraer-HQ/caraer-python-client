...
class TestCaraerErrorType(unittest.TestCase):
    """CaraerErrorType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CaraerErrorType:
        """Test CaraerErrorType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CaraerErrorType`
        """
        model = CaraerErrorType()
        if include_optional:
            return CaraerErrorType(
