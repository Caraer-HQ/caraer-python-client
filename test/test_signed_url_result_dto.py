...
class TestSignedUrlResultDTO(unittest.TestCase):
    """SignedUrlResultDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignedUrlResultDTO:
        """Test SignedUrlResultDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignedUrlResultDTO`
        """
        model = SignedUrlResultDTO()
        if include_optional:
    ...
    def testSignedUrlResultDTO(self):
        """Test SignedUrlResultDTO"""
