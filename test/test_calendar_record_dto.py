...
class TestCalendarRecordDTO(unittest.TestCase):
    """CalendarRecordDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarRecordDTO:
        """Test CalendarRecordDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarRecordDTO`
        """
        model = CalendarRecordDTO()
        if include_optional:
    ...
    def testCalendarRecordDTO(self):
        """Test CalendarRecordDTO"""
