...
class TestPaginationResponsePropertyOption(unittest.TestCase):
    """PaginationResponsePropertyOption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginationResponsePropertyOption:
        """Test PaginationResponsePropertyOption
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginationResponsePropertyOption`
        """
        model = PaginationResponsePropertyOption()
        if include_optional:
            return PaginationResponsePropertyOption(
                message = 'Success',
                data = [
    ...
    def testPaginationResponsePropertyOption(self):
        """Test PaginationResponsePropertyOption"""
