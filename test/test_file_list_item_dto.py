...
class TestFileListItemDTO(unittest.TestCase):
    """FileListItemDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileListItemDTO:
        """Test FileListItemDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileListItemDTO`
        """
        model = FileListItemDTO()
        if include_optional:
