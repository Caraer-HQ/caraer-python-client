...
class TestDeleteResponseString(unittest.TestCase):
    """DeleteResponseString unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteResponseString:
        """Test DeleteResponseString
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteResponseString`
        """
        model = DeleteResponseString()
        if include_optional:
    ...
    def testDeleteResponseString(self):
        """Test DeleteResponseString"""
