...
class TestMappingItemDTO(unittest.TestCase):
    """MappingItemDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MappingItemDTO:
        """Test MappingItemDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MappingItemDTO`
        """
        model = MappingItemDTO()
        if include_optional:
