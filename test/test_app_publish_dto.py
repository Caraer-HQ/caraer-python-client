...
class TestAppPublishDTO(unittest.TestCase):
    """AppPublishDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppPublishDTO:
        """Test AppPublishDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppPublishDTO`
        """
        model = AppPublishDTO()
        if include_optional:
            return AppPublishDTO(
                uuid = '0',
                name = '0',
                label = '',
                created_at = 56,
