...
class TestSuccessResponseCompanyDTO(unittest.TestCase):
    """SuccessResponseCompanyDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuccessResponseCompanyDTO:
        """Test SuccessResponseCompanyDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuccessResponseCompanyDTO`
        """
        model = SuccessResponseCompanyDTO()
        if include_optional:
    ...
    def testSuccessResponseCompanyDTO(self):
        """Test SuccessResponseCompanyDTO"""
