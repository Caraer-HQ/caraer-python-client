...
class TestRestoreResponseCaraerObjectDTO(unittest.TestCase):
    """RestoreResponseCaraerObjectDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestoreResponseCaraerObjectDTO:
        """Test RestoreResponseCaraerObjectDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestoreResponseCaraerObjectDTO`
        """
        model = RestoreResponseCaraerObjectDTO()
        if include_optional:
            return RestoreResponseCaraerObjectDTO(
                message = 'Success',
                data = caraer_client.models.caraer_object_dto.CaraerObjectDTO(
                    uuid = '0', 
                    name = '', 
                    label = '', 
                    created_at = 56, 
    ...
    def testRestoreResponseCaraerObjectDTO(self):
        """Test RestoreResponseCaraerObjectDTO"""
