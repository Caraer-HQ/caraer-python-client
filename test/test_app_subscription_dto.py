...
class TestAppSubscriptionDTO(unittest.TestCase):
    """AppSubscriptionDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppSubscriptionDTO:
        """Test AppSubscriptionDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppSubscriptionDTO`
        """
        model = AppSubscriptionDTO()
        if include_optional:
    ...
    def testAppSubscriptionDTO(self):
        """Test AppSubscriptionDTO"""
