...
class TestTemplateWebpageDTO(unittest.TestCase):
    """TemplateWebpageDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateWebpageDTO:
        """Test TemplateWebpageDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateWebpageDTO`
        """
        model = TemplateWebpageDTO()
        if include_optional:
            return TemplateWebpageDTO(
                uuid = '0',
                name = '0',
                label = '',
                created_at = 56,
    ...
    def testTemplateWebpageDTO(self):
        """Test TemplateWebpageDTO"""
