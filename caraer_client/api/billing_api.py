...
class BillingApi:
    ...
    def _get_status_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/billing/status',
    ...
    def send_setup_email(
        ...
        _param = self._send_setup_email_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def send_setup_email_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def send_setup_email_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _send_setup_email_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/billing/setup-email',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def send_jortt_invoice(
        self,
        jortt_invoice_id: Annotated[StrictStr, Field(description="Jortt invoice UUID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """Send a Jortt draft invoice

        Caraer BV ops: schedule sending of an existing Jortt draft invoice by id
        and mark the CRM invoice mirror as sent.

        :param jortt_invoice_id: Jortt invoice UUID (required)
        :type jortt_invoice_id: str
        :return: Returns the result object.
        """  # noqa: E501

        _param = self._send_jortt_invoice_serialize(
            jortt_invoice_id=jortt_invoice_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _send_jortt_invoice_serialize(
        self,
        jortt_invoice_id,
        _request_auth,
        _content_type,
        ...
        if jortt_invoice_id is not None:
            _path_params['jorttInvoiceId'] = jortt_invoice_id
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/billing/invoices/{jorttInvoiceId}/send',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
