...
class FileManagementApi:
    ...
    def list_library(
        self,
        record_uuid: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._list_library_serialize(
            record_uuid=record_uuid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SuccessResponseListFileListItemDTO",
            '401': "ErrorResponse",
            '403': "ErrorResponse",
            '404': "ErrorResponse",
            '500': "ErrorResponse",
    ...
    @validate_call
    def list_library_with_http_info(
        self,
        record_uuid: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SuccessResponseListFileListItemDTO]:
        """List company files with metadata for the media library
    ...
    @validate_call
    def list_library_without_preload_content(
        self,
        record_uuid: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _list_library_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/files/library',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
