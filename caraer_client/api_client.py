...
from caraer_client.configuration import Configuration
from caraer_client.api_response import ApiResponse, T as ApiResponseT
import caraer_client.models
from caraer_client import rest
from caraer_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/2.0.453/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(caraer_client.models, klass)
