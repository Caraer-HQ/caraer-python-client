...
class RecordSummary(BaseModel):
    ...
    parsed_properties: Optional[Dict[str, Any]] = Field(default=None, alias="parsedProperties")
    __properties: ClassVar[List[str]] = ["uuid", "object", "properties", "parsedProperties"]
