...
class PaginationResponsePropertyOption(BaseModel):
    """
    ...
    data: Optional[List[PropertyOption]] = Field(default=None, description="The data returned in the current page of the pagination.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [PropertyOption.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
