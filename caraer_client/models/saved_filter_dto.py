...
class SavedFilterDTO(BaseModel):
    ...
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The name identifier of the saved filter")
    label: Optional[StrictStr] = Field(default=None, description="Display label for the saved filter")
    ...
    description: Optional[StrictStr] = Field(default=None, description="Description of what this saved filter is used for")
    main_object: Optional[StrictStr] = Field(default=None, description="The main object for the saved filter", alias="mainObject")
    filter: Optional[Filter] = Field(default=None, description="The filter definition used when querying records")
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "description", "mainObject", "filter"]
