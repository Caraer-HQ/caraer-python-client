...
class AppScheduleDTO(BaseModel):
    """
    ...
    payload_template: Optional[StrictStr] = Field(default=None, alias="payloadTemplate")
    serverless_function: Optional[ServerlessFunctionRefDTO] = Field(default=None, alias="serverlessFunction")
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "schedule", "enabled", "payloadTemplate", "serverlessFunction"]
