...
class AnalyticsSeriesConfig(BaseModel):
    """
    AnalyticsSeriesConfig
    """ # noqa: E501
    group_by: Optional[AnalyticsPropertyRef] = Field(default=None, alias="groupBy")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groupBy": AnalyticsPropertyRef.from_dict(obj["groupBy"]) if obj.get("groupBy") is not None else None
        })
        return _obj
