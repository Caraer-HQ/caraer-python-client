...
class PublicFormDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "object", "grids", "description", "styling", "wizard", "metadata", "thankYouMessage", "redirectUrl"]
