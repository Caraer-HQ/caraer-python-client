...
class AppConnectionStatusDTO(BaseModel):
    """
    ...
    owner_user_uuid: Optional[StrictStr] = Field(default=None, alias="ownerUserUuid")
    account_label: Optional[StrictStr] = Field(default=None, alias="accountLabel")
    connected_at: Optional[StrictInt] = Field(default=None, alias="connectedAt")
    __properties: ClassVar[List[str]] = ["id", "name", "label", "preset", "logo", "connected", "ownerType", "ownerUserUuid", "accountLabel", "connectedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ownerUserUuid": obj.get("ownerUserUuid"),
