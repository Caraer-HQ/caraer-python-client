...
class FormDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "object", "grids", "description", "styling", "leadscores", "relations", "wizard", "metadata", "thankYouMessage", "redirectUrl"]
...
FormDTO.model_rebuild(raise_errors=False)
