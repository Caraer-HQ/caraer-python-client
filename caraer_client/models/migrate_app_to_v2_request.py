...
class MigrateAppToV2Request(BaseModel):
    """
    Request to migrate an existing V1 app to platform V2 (shared container runtime)
    """ # noqa: E501
    runtime: Optional[StrictStr] = Field(default=None, description="Required when functions disagree or none set: nodejs22 or python312", json_schema_extra={"examples": ["nodejs22"]})
    __properties: ClassVar[List[str]] = ["runtime"]
