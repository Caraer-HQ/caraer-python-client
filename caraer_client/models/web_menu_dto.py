...
class WebMenuDTO(BaseModel):
    ...
    title: Optional[StrictStr] = Field(default=None, description="The title of the web menu", json_schema_extra={"examples": ["Main Menu"]})
    active: Optional[StrictBool] = Field(default=None, description="Indicates whether the web menu is active", json_schema_extra={"examples": [True]})
    environments: Optional[List[StrictStr]] = Field(default=None, description="The environments of the web menu", json_schema_extra={"examples": [["production", "development"]]})
    location: Optional[StrictStr] = Field(default=None, description="The location of the web menu in the UI, e.g., 'footer_block_1' or 'header'", json_schema_extra={"examples": ["header"]})
    urls: Optional[List[Dict[str, StrictStr]]] = None
    items: Optional[List[WebMenuItem]] = None
    text: Optional[StrictStr] = Field(default=None, description="The text of the web menu", json_schema_extra={"examples": ["Welcome to our website"]})
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "title", "active", "environments", "location", "urls", "items", "text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "urls": obj.get("urls"),
            "items": [WebMenuItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "text": obj.get("text")
        })
        return _obj
