...
class AccessGrantTargetDTO(BaseModel):
    """
    A user, team, or app that can receive record access on an object.
    """ # noqa: E501
    uuid: Optional[StrictStr] = Field(default=None, description="UUID of the principal")
    label: Optional[StrictStr] = Field(default=None, description="Primary display label")
    subtitle: Optional[StrictStr] = Field(default=None, description="Secondary line (e.g. email)")
    __properties: ClassVar[List[str]] = ["uuid", "label", "subtitle"]
