...
class DeveloperSandboxDTO(BaseModel):
    """
    ...
    owner_company_uuid: Optional[StrictStr] = Field(default=None, description="UUID of the owning company — send this as X-Caraer-Company-Uuid", alias="ownerCompanyUuid")
    database_id: Optional[StrictStr] = Field(default=None, description="Neo4j database id of the sandbox clone", alias="databaseId")
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "ownerCompanyUuid", "databaseId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "index": obj.get("index"),
            "ownerCompanyUuid": obj.get("ownerCompanyUuid"),
