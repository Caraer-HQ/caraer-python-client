...
class CustomFontDTO(BaseModel):
    """
    CustomFontDTO
    """ # noqa: E501
    family_name: Optional[StrictStr] = Field(default=None, alias="familyName")
    variants: Optional[List[FontVariantDTO]] = None
    __properties: ClassVar[List[str]] = ["familyName", "variants"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "variants": [FontVariantDTO.from_dict(_item) for _item in obj["variants"]] if obj.get("variants") is not None else None
        })
        return _obj
