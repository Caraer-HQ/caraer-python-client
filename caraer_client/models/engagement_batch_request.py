...
class EngagementBatchRequest(BaseModel):
    ...
    events: Optional[List[TrackingEventRequest]] = None
    __properties: ClassVar[List[str]] = ["visitorId", "sessionId", "events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "events": [TrackingEventRequest.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
