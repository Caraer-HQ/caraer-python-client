...
class FeedDTO(BaseModel):
    ...
    filter_json: Optional[StrictStr] = Field(default=None, alias="filterJson")
    mapping: Optional[Any] = None
    mapping_json: Optional[StrictStr] = Field(default=None, alias="mappingJson")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filterJson": obj.get("filterJson"),
            "mapping": obj.get("mapping"),
            "mappingJson": obj.get("mappingJson"),
