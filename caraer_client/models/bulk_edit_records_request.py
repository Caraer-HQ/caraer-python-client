...
class BulkEditRecordsRequest(BaseModel):
    ...
    """ # noqa: E501
    records: Optional[List[BulkEditRecordItem]] = Field(default=None, description="Records to create or update.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [BulkEditRecordItem.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
