...
class CreateOrUpdateEnvironmentRequest(BaseModel):
    """
    CreateOrUpdateEnvironmentRequest
    """ # noqa: E501
    environment: Optional[StrictStr] = None
    webpage_objects: Optional[List[CaraerObjectDTO]] = Field(default=None, alias="webpageObjects")
    __properties: ClassVar[List[str]] = ["environment", "webpageObjects"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in webpage_objects (list)
        _items = []
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "webpageObjects": [CaraerObjectDTO.from_dict(_item) for _item in obj["webpageObjects"]] if obj.get("webpageObjects") is not None else None
        })
        return _obj
