...
class CmsPagePatchRequest(BaseModel):
    """
    CmsPagePatchRequest
    """ # noqa: E501
    locale: Optional[StrictStr] = None
    patches: Optional[List[CmsPagePatch]] = None
    expected_revision: Optional[StrictInt] = Field(default=None, alias="expectedRevision")
    __properties: ClassVar[List[str]] = ["locale", "patches", "expectedRevision"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "patches": [CmsPagePatch.from_dict(_item) for _item in obj["patches"]] if obj.get("patches") is not None else None,
