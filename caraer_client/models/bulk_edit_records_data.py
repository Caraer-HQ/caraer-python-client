...
class BulkEditRecordsData(BaseModel):
    """
    Payload of a bulk edit records response.
    """ # noqa: E501
    records: Optional[List[BulkEditRecordResultItem]] = Field(default=None, description="Successfully saved records.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [BulkEditRecordResultItem.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
