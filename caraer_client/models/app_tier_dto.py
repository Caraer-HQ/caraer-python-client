...
class AppTierDTO(BaseModel):
    ...
    start_units: Optional[StrictStr] = Field(default=None, description="Start of unit range (e.g. 0)", alias="startUnits")
    end_units: Optional[StrictStr] = Field(default=None, description="End of unit range (e.g. 1000 or null for unlimited)", alias="endUnits")
    price_per_month: Optional[StrictStr] = Field(default=None, description="Price per month (e.g. 10.00)", alias="pricePerMonth")
    price_per_year: Optional[StrictStr] = Field(default=None, description="Price per year (e.g. 100.00)", alias="pricePerYear")
    price_per_extra_unit: Optional[StrictStr] = Field(default=None, description="Price per extra unit beyond tier (e.g. 0.01, typically for last tier)", alias="pricePerExtraUnit")
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "startUnits", "endUnits", "pricePerMonth", "pricePerYear", "pricePerExtraUnit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "index": obj.get("index"),
            "startUnits": obj.get("startUnits"),
            "endUnits": obj.get("endUnits"),
            "pricePerMonth": obj.get("pricePerMonth"),
            "pricePerYear": obj.get("pricePerYear"),
