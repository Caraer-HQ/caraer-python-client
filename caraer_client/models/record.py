...
class Record(BaseModel):
    ...
    deleted_at: Optional[StrictInt] = Field(default=None, alias="deletedAt")
    created_by_uuid: Optional[StrictStr] = Field(default=None, alias="createdByUuid")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "createdByUuid": obj.get("createdByUuid"),
...
Record.model_rebuild(raise_errors=False)
