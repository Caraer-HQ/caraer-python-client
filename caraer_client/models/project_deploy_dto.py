...
class ProjectDeployDTO(BaseModel):
    """
    ...
    build_uuid: Optional[StrictStr] = Field(default=None, description="UUID of the build that was deployed", alias="buildUuid")
    version: Optional[StrictStr] = Field(default=None, description="Semantic version of the deployed build", json_schema_extra={"examples": ["1.2.3"]})
    status: Optional[StrictStr] = Field(default=None, description="PENDING, SUCCEEDED, FAILED, or PARTIAL")
    target: Optional[StrictStr] = Field(default=None, description="production or sandbox")
    results_json: Optional[StrictStr] = Field(default=None, description="Per-component reconciliation results (app, functions, webhooks), serialized as JSON", alias="resultsJson")
    activated_at: Optional[StrictInt] = Field(default=None, description="Unix timestamp (ms) when this deploy was activated", alias="activatedAt")
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "projectUuid", "buildUuid", "version", "status", "target", "resultsJson", "activatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "buildUuid": obj.get("buildUuid"),
            "version": obj.get("version"),
            "status": obj.get("status"),
            "target": obj.get("target"),
            "resultsJson": obj.get("resultsJson"),
