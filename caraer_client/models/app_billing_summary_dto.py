...
class AppBillingSummaryDTO(BaseModel):
    """
    Rollup of installation billing status
    """ # noqa: E501
    installation_count: Optional[StrictInt] = Field(default=None, alias="installationCount")
    projected_revenue_total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="projectedRevenueTotal")
    __properties: ClassVar[List[str]] = ["installationCount", "projectedRevenueTotal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "projectedRevenueTotal": obj.get("projectedRevenueTotal")
        })
        return _obj
