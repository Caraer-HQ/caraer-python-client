...
class PaginationResponsePreviewDTO(BaseModel):
    """
    ...
    data: Optional[List[PreviewDTO]] = Field(default=None, description="The data returned in the current page of the pagination.", json_schema_extra={"examples": [[{"id": 1, "name": "Item1"}, {"id": 2, "name": "Item2"}]]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [PreviewDTO.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
