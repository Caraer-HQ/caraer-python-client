...
class MappingItemDTO(BaseModel):
    ...
    source_field: Optional[StrictStr] = Field(default=None, alias="sourceField")
    target_object: Optional[CaraerObjectDTO] = Field(default=None, alias="targetObject")
    target_property: Optional[PropertyDTO] = Field(default=None, alias="targetProperty")
    conversion_function: Optional[StrictStr] = Field(default=None, alias="conversionFunction")
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "sourceField", "targetObject", "targetProperty", "conversionFunction"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of target_object
        if self.target_object:
            _dict['targetObject'] = self.target_object.to_dict()
        # override the default output from pydantic by calling `to_dict()` of target_property
        if self.target_property:
            _dict['targetProperty'] = self.target_property.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "targetObject": CaraerObjectDTO.from_dict(obj["targetObject"]) if obj.get("targetObject") is not None else None,
            "targetProperty": PropertyDTO.from_dict(obj["targetProperty"]) if obj.get("targetProperty") is not None else None,
            "conversionFunction": obj.get("conversionFunction")
        })
        return _obj
