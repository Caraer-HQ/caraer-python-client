...
class RelationDTO(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Unique identifier name for the relation")
    label: Optional[StrictStr] = Field(default=None, description="Display label for the relation")
    ...
    description: Optional[StrictStr] = Field(default=None, description="Detailed description of the relation's purpose and usage")
    objects: Optional[List[CaraerObjectDTO]] = Field(default=None, description="Set of Caraer objects that are part of this relation")
    immutable: Optional[StrictBool] = Field(default=None, description="Whether the relation is immutable")
    editable: Optional[StrictBool] = Field(default=None, description="Whether the relation is editable")
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "description", "objects", "immutable", "editable"]
...
RelationDTO.model_rebuild(raise_errors=False)
