...
class CalendarTeamMemberDTO(BaseModel):
    """
    ...
    has_user_trait: Optional[StrictBool] = Field(default=None, alias="hasUserTrait")
    __properties: ClassVar[List[str]] = ["uuid", "label", "objectName", "hasUserTrait"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hasUserTrait": obj.get("hasUserTrait")
        })
        return _obj
