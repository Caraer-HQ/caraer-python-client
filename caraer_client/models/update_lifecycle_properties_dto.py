...
class UpdateLifecyclePropertiesDTO(BaseModel):
    """
    Request body for enabling lifecycle tracking on object properties
    """ # noqa: E501
    property_uuids: Optional[List[StrictStr]] = Field(default=None, description="UUIDs of properties to track in lifecycle history", alias="propertyUuids")
    __properties: ClassVar[List[str]] = ["propertyUuids"]
