...
class WebpageProtectionInfoDTO(BaseModel):
    """
    Public protection metadata for a webpage (no content)
    """ # noqa: E501
    protection_required: Optional[StrictBool] = Field(default=None, alias="protectionRequired")
    type: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    uuid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["protectionRequired", "type", "title", "uuid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "protectionRequired": obj.get("protectionRequired"),
            "type": obj.get("type"),
            "title": obj.get("title"),
            "uuid": obj.get("uuid")
        })
