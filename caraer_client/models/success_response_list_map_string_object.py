...
class SuccessResponseListMapStringObject(BaseModel):
    """
    ...
    data: Optional[List[Dict[str, Any]]] = Field(default=None, description="The data payload of the response, if any.")
