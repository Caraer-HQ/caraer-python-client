...
class ShowResponseListAppInstallationBillingStatusDTO(BaseModel):
    """
    ...
    data: Optional[List[AppInstallationBillingStatusDTO]] = Field(default=None, description="The data payload of the response, if any.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [AppInstallationBillingStatusDTO.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
