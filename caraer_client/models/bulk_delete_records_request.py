...
class BulkDeleteRecordsRequest(BaseModel):
    ...
    """ # noqa: E501
    uuids: List[StrictStr] = Field(description="Record UUIDs to delete.")
    mode: StrictStr = Field(description="Deletion mode: 'archive', 'anonymize', or 'delete'.", json_schema_extra={"examples": ["archive"]})
    __properties: ClassVar[List[str]] = ["uuids", "mode"]
