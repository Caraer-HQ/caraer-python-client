...
class WebpageEditingStatusDTO(BaseModel):
    """
    Whether a webpage is currently being edited by another user
    """ # noqa: E501
    locked: Optional[StrictBool] = Field(default=None, description="True when another user is actively editing this webpage")
    editor: Optional[UserWithCursorLocationDTO] = Field(default=None, description="The user currently editing, when locked is true")
    message: Optional[StrictStr] = Field(default=None, description="Human-readable message for the client UI")
    __properties: ClassVar[List[str]] = ["locked", "editor", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "editor": UserWithCursorLocationDTO.from_dict(obj["editor"]) if obj.get("editor") is not None else None,
