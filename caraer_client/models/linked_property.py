...
class LinkedProperty(PropertyFormat):
    """
    LinkedProperty
    """ # noqa: E501
    linked_property: Optional[PropertyDTO] = Field(default=None, alias="linkedProperty")
    __properties: ClassVar[List[str]] = ["label", "name", "icon", "type", "settings", "filters", "rules", "linkedProperty"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LinkedProperty from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.linked_property:
            _dict['linkedProperty'] = self.linked_property.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LinkedProperty from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "rules": obj.get("rules"),
            "linkedProperty": PropertyDTO.from_dict(obj["linkedProperty"]) if obj.get("linkedProperty") is not None else None
        })
        return _obj

from caraer_client.models.property_dto import PropertyDTO
# TODO: Rewrite to not use raise_errors
LinkedProperty.model_rebuild(raise_errors=False)
