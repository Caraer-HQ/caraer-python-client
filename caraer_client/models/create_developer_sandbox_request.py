...
class CreateDeveloperSandboxRequest(BaseModel):
    """
    Request body for creating a developer sandbox.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Sandbox name.", json_schema_extra={"examples": ["qa-sandbox"]})
    label: Optional[StrictStr] = Field(default=None, description="Optional human-readable label for the sandbox.", json_schema_extra={"examples": ["QA Sandbox"]})
