...
class AppPublishDTO(BaseModel):
    ...
    publish_state: Optional[StrictStr] = Field(default=None, description="Publish state: DRAFT, SUBMITTED, IN_REVIEW, APPROVED, PUBLISHED, REJECTED, CHANGES_REQUESTED", alias="publishState")
    submitted_at: Optional[StrictInt] = Field(default=None, description="Timestamp when developer submitted for review", alias="submittedAt")
