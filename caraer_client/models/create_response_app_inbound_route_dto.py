...
class CreateResponseAppInboundRouteDTO(BaseModel):
    """
    ...
    data: Optional[AppInboundRouteDTO] = Field(default=None, description="The data payload of the response, if any.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": AppInboundRouteDTO.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
