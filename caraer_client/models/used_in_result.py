...
class UsedInResult(BaseModel):
    """
    UsedInResult
    """ # noqa: E501
    record_uuids: Optional[List[StrictStr]] = Field(default=None, alias="recordUuids")
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["recordUuids", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recordUuids": obj.get("recordUuids"),
            "count": obj.get("count")
        })
        return _obj
