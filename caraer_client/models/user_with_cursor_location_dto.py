...
class UserWithCursorLocationDTO(BaseModel):
    """
    ...
    cursor_location: Optional[CursorLocation] = Field(default=None, alias="cursorLocation")
    reference: Optional[StrictStr] = None
    session_id: Optional[StrictStr] = Field(default=None, alias="sessionId")
    __properties: ClassVar[List[str]] = ["uuid", "email", "firstname", "lastname", "cursorLocation", "reference", "sessionId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of cursor_location
        if self.cursor_location:
            _dict['cursorLocation'] = self.cursor_location.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cursorLocation": CursorLocation.from_dict(obj["cursorLocation"]) if obj.get("cursorLocation") is not None else None,
