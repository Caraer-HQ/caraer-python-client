...
class SamplePayloadRequest(BaseModel):
    """
    Request body for generating a sample webhook payload from a record and event type.
    """ # noqa: E501
    record_uuid: Optional[StrictStr] = Field(default=None, description="UUID of the record to base the sample payload on.", alias="recordUuid", json_schema_extra={"examples": ["record-uuid"]})
    ...
    __properties: ClassVar[List[str]] = ["recordUuid", "eventType"]
