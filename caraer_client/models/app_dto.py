...
class AppDTO(BaseModel):
    ...
    hide_api_key_field: Optional[StrictBool] = Field(default=None, description="Whether to hide the API token field in app settings UI", alias="hideApiKeyField")
