...
class FormWithAiPromptDTO(BaseModel):
    """
    ...
    object: Optional[CaraerObjectDTO] = Field(default=None, description="The associated Caraer object that this form belongs to")
    grids: Optional[List[FormItemDTO]] = Field(default=None, description="List of form items that make up the form's structure. Each grid represents a section or group of form elements")
    description: Optional[StrictStr] = Field(default=None, description="Descriptive text providing additional information about the form")
    styling: Optional[StrictStr] = Field(default=None, description="The styling of the form. Can be 'standard', 'underline' or 'plain'")
    leadscores: Optional[List[Leadscore]] = Field(default=None, description="List of lead scoring rules associated with this form. Used to evaluate and score form submissions")
    relations: Optional[List[FormRelationDTO]] = Field(default=None, description="List of form relations that define the relationships between this form conversion record and other records in the system")
    wizard: Optional[StrictBool] = Field(default=None, description="Indicates if the form should be displayed as a step-by-step wizard interface")
    metadata: Optional[Dict[str, StrictStr]] = Field(default=None, description="Metadata associated with the form")
    thank_you_message: Optional[StrictStr] = Field(default=None, description="Thank you message to be displayed after the form is submitted", alias="thankYouMessage")
    redirect_url: Optional[StrictStr] = Field(default=None, description="Redirect URL to be displayed after the form is submitted", alias="redirectUrl")
    ai_prompt: Optional[StrictStr] = Field(default=None, description="AI prompt to be used for the form", alias="aiPrompt")
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "object", "grids", "description", "styling", "leadscores", "relations", "wizard", "metadata", "thankYouMessage", "redirectUrl", "aiPrompt"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in grids (list)
        _items = []
        if self.grids:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "grids": [FormItemDTO.from_dict(_item) for _item in obj["grids"]] if obj.get("grids") is not None else None,
            "description": obj.get("description"),
            "styling": obj.get("styling"),
            "leadscores": [Leadscore.from_dict(_item) for _item in obj["leadscores"]] if obj.get("leadscores") is not None else None,
            "relations": [FormRelationDTO.from_dict(_item) for _item in obj["relations"]] if obj.get("relations") is not None else None,
            "wizard": obj.get("wizard"),
            "metadata": obj.get("metadata"),
            "thankYouMessage": obj.get("thankYouMessage"),
