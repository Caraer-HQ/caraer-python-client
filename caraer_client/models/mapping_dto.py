...
class MappingDTO(BaseModel):
    ...
    sync_rate: Optional[StrictInt] = Field(default=None, alias="syncRate")
    active: Optional[StrictBool] = None
    mapping_items: Optional[List[MappingItemDTO]] = Field(default=None, alias="mappingItems")
    object: Optional[CaraerObjectDTO] = None
    unpublish_when_not_in_source: Optional[StrictBool] = Field(default=None, alias="unpublishWhenNotInSource")
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "sourceUrl", "syncRate", "active", "mappingItems", "object", "unpublishWhenNotInSource"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in mapping_items (list)
        _items = []
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mappingItems": [MappingItemDTO.from_dict(_item) for _item in obj["mappingItems"]] if obj.get("mappingItems") is not None else None,
            "object": CaraerObjectDTO.from_dict(obj["object"]) if obj.get("object") is not None else None,
            "unpublishWhenNotInSource": obj.get("unpublishWhenNotInSource")
        })
        return _obj
