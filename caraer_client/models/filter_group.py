...
class FilterGroup(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[FilterItem] = Field(default=None, description="A set of filter items included in the group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": FilterItem.from_dict(obj["items"]) if obj.get("items") is not None else None
        })
        return _obj
