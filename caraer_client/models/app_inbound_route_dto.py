...
class AppInboundRouteDTO(BaseModel):
    """
    ...
    enqueue: Optional[StrictBool] = None
    has_shared_secret: Optional[StrictBool] = Field(default=None, alias="hasSharedSecret")
    shared_secret: Optional[StrictStr] = Field(default=None, alias="sharedSecret")
    serverless_function: Optional[ServerlessFunctionRefDTO] = Field(default=None, alias="serverlessFunction")
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "authMode", "enqueue", "hasSharedSecret", "sharedSecret", "serverlessFunction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enqueue": obj.get("enqueue"),
            "hasSharedSecret": obj.get("hasSharedSecret"),
            "sharedSecret": obj.get("sharedSecret"),
            "serverlessFunction": ServerlessFunctionRefDTO.from_dict(obj["serverlessFunction"]) if obj.get("serverlessFunction") is not None else None
        })
        return _obj
