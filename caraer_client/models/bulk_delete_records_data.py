...
class BulkDeleteRecordsData(BaseModel):
    """
    Payload of a bulk delete records response.
    """ # noqa: E501
    uuids: Optional[List[StrictStr]] = Field(default=None, description="UUIDs that were successfully deleted.")
    __properties: ClassVar[List[str]] = ["uuids"]
