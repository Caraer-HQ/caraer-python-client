...
class RegisterRequest(BaseModel):
    ...
    password: Annotated[str, Field(min_length=8, strict=True, max_length=2147483647)]
    firstname: Annotated[str, Field(min_length=1, strict=True)]
    lastname: Annotated[str, Field(min_length=1, strict=True)]
