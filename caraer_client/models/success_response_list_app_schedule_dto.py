...
class SuccessResponseListAppScheduleDTO(BaseModel):
    """
    ...
    data: Optional[List[AppScheduleDTO]] = Field(default=None, description="The data payload of the response, if any.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [AppScheduleDTO.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
