...
class WebpageMapLocationsDTO(BaseModel):
    """
    Resolved public map markers for a webpage map block
    """ # noqa: E501
    map_locations: Optional[List[MapLocationDTO]] = Field(default=None, description="Concrete markers after applying public filters", alias="mapLocations")
    __properties: ClassVar[List[str]] = ["mapLocations"]
