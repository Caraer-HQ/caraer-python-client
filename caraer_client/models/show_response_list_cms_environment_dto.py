...
class ShowResponseListCmsEnvironmentDTO(BaseModel):
    """
    ...
    data: Optional[List[CmsEnvironmentDTO]] = Field(default=None, description="The data payload of the response, if any.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [CmsEnvironmentDTO.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
