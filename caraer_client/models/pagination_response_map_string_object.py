...
class PaginationResponseMapStringObject(BaseModel):
    """
    ...
    data: Optional[List[Dict[str, Any]]] = Field(default=None, description="The data returned in the current page of the pagination.")
