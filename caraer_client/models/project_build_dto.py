...
class ProjectBuildDTO(BaseModel):
    """
    ...
    project_uuid: Optional[StrictStr] = Field(default=None, description="UUID of the owning developer project", alias="projectUuid")
    status: Optional[StrictStr] = Field(default=None, description="PENDING, READY, or FAILED")
    target: Optional[StrictStr] = Field(default=None, description="production or sandbox")
    artifact_gcs_path: Optional[StrictStr] = Field(default=None, description="GCS object path of the uploaded build archive", alias="artifactGcsPath")
    manifest_json: Optional[StrictStr] = Field(default=None, description="Parsed build manifest (functions, webhooks, app fields), serialized as JSON", alias="manifestJson")
    error_message: Optional[StrictStr] = Field(default=None, description="Error message if the build failed", alias="errorMessage")
    version: Optional[StrictStr] = Field(default=None, description="Semantic version for this build", json_schema_extra={"examples": ["1.2.3"]})
    release_notes: Optional[StrictStr] = Field(default=None, description="Release notes for this build", alias="releaseNotes")
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "projectUuid", "status", "target", "artifactGcsPath", "manifestJson", "errorMessage", "version", "releaseNotes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "index": obj.get("index"),
            "projectUuid": obj.get("projectUuid"),
            "status": obj.get("status"),
            "target": obj.get("target"),
            "artifactGcsPath": obj.get("artifactGcsPath"),
            "manifestJson": obj.get("manifestJson"),
