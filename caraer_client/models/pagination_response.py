...
class PaginationResponse(BaseModel):
    ...
    data: Optional[List[Any]] = Field(default=None, description="The data returned in the current page of the pagination.", json_schema_extra={"examples": [[{"id": 1, "name": "Item1"}, {"id": 2, "name": "Item2"}]]})
