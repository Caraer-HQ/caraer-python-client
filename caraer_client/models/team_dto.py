...
class TeamDTO(BaseModel):
    ...
    members: Optional[List[UserRecordResponseDTO]] = None
    ...
    __properties: ClassVar[List[str]] = ["description", "memberCount", "scopes", "members", "filters", "uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "members": [UserRecordResponseDTO.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,
            "filters": dict(
