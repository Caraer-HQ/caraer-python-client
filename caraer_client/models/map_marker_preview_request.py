...
class MapMarkerPreviewRequest(BaseModel):
    """
    MapMarkerPreviewRequest
    """ # noqa: E501
    record_uuid: Optional[StrictStr] = Field(default=None, alias="recordUuid")
    preview_uuid: Optional[StrictStr] = Field(default=None, alias="previewUuid")
    preview_name: Optional[StrictStr] = Field(default=None, alias="previewName")
    __properties: ClassVar[List[str]] = ["recordUuid", "previewUuid", "previewName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "previewUuid": obj.get("previewUuid"),
            "previewName": obj.get("previewName")
        })
        return _obj
