...
class AnalyticsDashboardConfig(BaseModel):
    ...
    widgets: Optional[List[AnalyticsWidgetConfig]] = None
    __properties: ClassVar[List[str]] = ["version", "columns", "widgets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "widgets": [AnalyticsWidgetConfig.from_dict(_item) for _item in obj["widgets"]] if obj.get("widgets") is not None else None
        })
        return _obj
