...
class ObjectAccessGrantRequestDTO(BaseModel):
    """
    Request to grant record-level access on an object to users, teams, and apps.
    """ # noqa: E501
    users: Optional[ObjectAccessGrantSectionDTO] = Field(default=None, description="User grants")
    teams: Optional[ObjectAccessGrantSectionDTO] = Field(default=None, description="Team grants")
    apps: Optional[ObjectAccessGrantSectionDTO] = Field(default=None, description="Installed app grants")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": ObjectAccessGrantSectionDTO.from_dict(obj["users"]) if obj.get("users") is not None else None,
            "teams": ObjectAccessGrantSectionDTO.from_dict(obj["teams"]) if obj.get("teams") is not None else None,
            "apps": ObjectAccessGrantSectionDTO.from_dict(obj["apps"]) if obj.get("apps") is not None else None
        })
        return _obj
