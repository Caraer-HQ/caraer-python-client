...
class AppPricingDTO(BaseModel):
    ...
    title: Optional[StrictStr] = Field(default=None, description="Pricing title")
    description: Optional[StrictStr] = Field(default=None, description="Pricing description")
    pricing_type: Optional[StrictStr] = Field(default=None, description="Pricing type: TIERED or FLAT", alias="pricingType")
    price_per_unit: Optional[StrictStr] = Field(default=None, description="Price per unit (FLAT, e.g. 10.00)", alias="pricePerUnit")
    unit: Optional[StrictStr] = Field(default=None, description="Unit label (FLAT, e.g. document)")
    free_units: Optional[StrictStr] = Field(default=None, description="Free units included (FLAT, e.g. 100)", alias="freeUnits")
    free_units_period: Optional[StrictStr] = Field(default=None, description="Free units period (FLAT, e.g. month)", alias="freeUnitsPeriod")
    tiers: Optional[List[AppTierDTO]] = Field(default=None, description="Tiers for tiered pricing (TIERED)")
    __properties: ClassVar[List[str]] = ["uuid", "name", "label", "createdAt", "createdBy", "updatedAt", "updatedBy", "deletedAt", "deletedBy", "index", "title", "description", "pricingType", "pricePerUnit", "unit", "freeUnits", "freeUnitsPeriod", "tiers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "freeUnitsPeriod": obj.get("freeUnitsPeriod"),
