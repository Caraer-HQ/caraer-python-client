...
class AggregateBatchRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[List[AggregateRequest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [AggregateRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
