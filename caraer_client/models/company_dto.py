...
class CompanyDTO(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of digital_identity
        if self.digital_identity:
            _dict['digitalIdentity'] = self.digital_identity.to_dict()
        # override the default output from pydantic by calling `to_dict()` of website_settings
        if self.website_settings:
            _dict['websiteSettings'] = self.website_settings.to_dict()
