...
class BulkEditRecordsResponse(BaseModel):
    """
    ...
    data: Optional[BulkEditRecordsData] = Field(default=None, description="Successfully saved records.")
    errors: Optional[List[BulkEditRecordErrorItem]] = Field(default=None, description="Per-record errors when one or more items failed validation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": BulkEditRecordsData.from_dict(obj["data"]) if obj.get("data") is not None else None,
