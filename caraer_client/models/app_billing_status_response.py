...
class AppBillingStatusResponse(BaseModel):
    """
    ...
    installations: Optional[List[AppInstallationBillingStatusDTO]] = None
    summary: Optional[AppBillingSummaryDTO] = None
    __properties: ClassVar[List[str]] = ["appUuid", "appName", "period", "installations", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "installations": [AppInstallationBillingStatusDTO.from_dict(_item) for _item in obj["installations"]] if obj.get("installations") is not None else None,
            "summary": AppBillingSummaryDTO.from_dict(obj["summary"]) if obj.get("summary") is not None else None
        })
        return _obj
