...
class AppBarIframeSessionValidateRequest(BaseModel):
    """
    Request body for validating an iframe session token
    """ # noqa: E501
    token: Optional[StrictStr] = Field(default=None, description="Opaque iframe session token from the iframe URL")
