...
class AppSubscriptionChangeRequest(BaseModel):
    """
    Schedule a plan or commitment change
    """ # noqa: E501
    target_plan_uuid: Optional[StrictStr] = Field(default=None, alias="targetPlanUuid")
    target_commitment: Optional[StrictStr] = Field(default=None, description="MONTHLY or ANNUAL", alias="targetCommitment")
    __properties: ClassVar[List[str]] = ["targetPlanUuid", "targetCommitment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "targetPlanUuid": obj.get("targetPlanUuid"),
            "targetCommitment": obj.get("targetCommitment")
        })
        return _obj
