...
class ShowResponseListWebpageAccessGrantDTO(BaseModel):
    """
    ...
    data: Optional[List[WebpageAccessGrantDTO]] = Field(default=None, description="The data payload of the response, if any.")
