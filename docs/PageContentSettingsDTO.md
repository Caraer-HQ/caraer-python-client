...
**target_page_path** | **str** | Public path of the page that owns the linked preview, for the search component | [optional] 
**target_page_uuid** | **str** | Webpage uuid of the page that owns the linked preview | [optional] 
**target_preview_uuid** | **str** | Page content uuid of the preview component the search component links to | [optional] 
