...
json = "{}"
# create an instance of FormDTO from a JSON string
form_dto_instance = FormDTO.from_json(json)
# print the JSON string representation of the object
print(FormDTO.to_json())

# convert the object into a dict
form_dto_dict = form_dto_instance.to_dict()
# create an instance of FormDTO from a dict
form_dto_from_dict = FormDTO.from_dict(form_dto_dict)
```
