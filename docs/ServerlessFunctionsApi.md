...
------------- | ------------- | -------------
[**create1**](ServerlessFunctionsApi.md#create1) | **POST** /api/v2/apps/{appUuid}/serverless-functions | Create a serverless function
...
[**show**](ServerlessFunctionsApi.md#show) | **GET** /api/v2/apps/{appUuid}/serverless-functions/{uuid} | Get a serverless function
...
# **create1**
> CreateResponse create1(app_uuid, serverless_function_dto)
...
with caraer_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a serverless function
        api_response = api_instance.create1(app_uuid, serverless_function_dto)
        print("The response of ServerlessFunctionsApi->create1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ServerlessFunctionsApi->create1: %s\n" % e)
```
...
# **show**
> ShowResponse show(app_uuid, uuid)
...
with caraer_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a serverless function
        api_response = api_instance.show(app_uuid, uuid)
        print("The response of ServerlessFunctionsApi->show:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ServerlessFunctionsApi->show: %s\n" % e)
```
